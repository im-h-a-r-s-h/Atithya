...
//               geometry: {
//                 type: "Point",
//                 coordinates: [77.2090, 28.6139], // dummy: New Delhi
//               },
//             },
//           ],
//         },
...
module.exports.createListing = async (req, res, next) => {
    const coordinates = await getCoordinates(req.body.listing.location);  // Use getCoordinates function
...
module.exports.updateListing = async (req, res) => {
    ...
    const coordinates = await getCoordinates(`${req.body.listing.location}, ${req.body.listing.country}`);  // Use getCoordinates function
